...
def download_data_set(year: int, day: int) -> list[str]:
    input_data = ""
...
def get_data_set(year: int, day: int) -> list[str]:
    ret = []
    ...
    if os.path.isfile(data_file_path):
        ...
        ret = download_data_set(year, day)

    return ret


def run_with_data_set(fun: Callable, year: int, day: int):
    data_set = get_data_set(year, day)
